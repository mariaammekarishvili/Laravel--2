...
return [
    ...
    */
    ...
    'filled'               => ':attribute სავალდებულოა.',
    'gt' => [
        'numeric' => ':attribute უნდა მეტი იყოს ვიდრე :value.',
    ...
    'required_if'          => ':attribute სავალდებულოა, თუ :other-ის მნიშვნელობა ემთხვევა :value-ს.',
    'required_unless'      => ':attribute სავალდებულოა, თუ :values არ შეიცავს :other-ს.',
    'required_with'        => ':attribute სავალდებულოა, თუ :values მითითებულია.',
    'required_with_all'    => ':attribute სავალდებულოა, თუ :values მითითებულია.',
    'required_without'     => ':attribute სავალდებულოა, თუ :values არ არის მითითებული.',
    'required_without_all' => ':attribute სავალდებულოა, თუ :values არ არის მითითებული.',
    ...
    'starts_with' => ':attribute უნდა იწყებოდეს :values-ით.',
    ...
    */
    ...
    'attributes'           => [
        ...
        'email' => 'ელ.ფოსტა',
        'question' => 'შეკითხვა',
        'is_test' => 'შეკითხვის ტიპი',
        'has_multiple_choice' => 'პასუხის ტიპი',
        'answers.*.name' => 'პასუხი',
        'answers.*.point' => 'ქულა',
        'competency_id' => 'კომპეტენცია',
        'questions.*.question_id' => 'შეკითხვა',
        'questions.*.answers.*.name' => 'პასუხი',
        'questions.*.answers.*.point' => 'ქულა',
        'project_id' => 'პროექტი',
        'identity_number' => 'პირადი ნომერი',
        'positions.*.project_id' => 'პროექტი',
        'positions.*.position_id' => 'თანამდებობა',
        'poll_subjects' => 'გამოკითხვის სუბიექტები',
        'team_id' => 'გუნდი',
    ],
